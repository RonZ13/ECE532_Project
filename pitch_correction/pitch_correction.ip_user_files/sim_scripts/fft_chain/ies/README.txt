...
#
# Generated by export_simulation on Tue Mar 26 23:37:41 -0400 2024
#
################################################################################
...
'-reset_run' switch to the './fft_chain.sh' script.

./fft_chain.sh -reset_run
...
./fft_chain.sh -noclean_files

For more information on the script, please type './fft_chain.sh -help'.
