...
--               C:/vims/new_pwm_demo/new_pwm/pitch_correction/pitch_correction.srcs/sources_1/bd/fft_chain/ip/fft_chain_spi_0_0/fft_chain_spi_0_0_sim_netlist.vhdl
...
entity fft_chain_spi_0_0_spi is
  port (
    ...
    monitor_audio_in : out STD_LOGIC_VECTOR ( 0 to 0 );
    rst : in STD_LOGIC;
    clk : in STD_LOGIC;
    miso : in STD_LOGIC
  );
...
architecture STRUCTURE of fft_chain_spi_0_0_spi is
  ...
  signal monitor_audio_reg_n_0 : STD_LOGIC;
...
monitor_audio_reg: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000010"
    )
        port map (
      ...
      I3 => bit_count(0),
      I4 => bit_count(1),
      O => monitor_audio_reg_n_0
    );
\monitor_audio_reg_reg[11]\: unisim.vcomponents.FDCE
     port map (
      C => \^sck_reg_0\,
      CE => monitor_audio_reg_n_0,
      CLR => rst,
      D => \audio_data_reg_n_0_[11]\,
      Q => monitor_audio_in(0)
    );
...
architecture STRUCTURE of fft_chain_spi_0_0 is
  ...
  signal \^monitor_audio_in\ : STD_LOGIC_VECTOR ( 11 downto 0 );
  signal \^shifted_pcm_out\ : STD_LOGIC_VECTOR ( 11 to 11 );
...
begin
  monitor_audio_in(11 downto 0) <= \^monitor_audio_in\(11 downto 0);
  shifted_PCM_out(11) <= \^shifted_pcm_out\(11);
  shifted_PCM_out(10 downto 0) <= \^monitor_audio_in\(10 downto 0);
...
inst: entity work.fft_chain_spi_0_0_spi
     port map (
      ...
      data_vld => data_vld,
      miso => miso,
      monitor_audio_in(0) => \^monitor_audio_in\(11),
      rst => rst,
      sck_reg_0 => sck,
      shifted_PCM_out(11) => \^shifted_pcm_out\(11),
      shifted_PCM_out(10 downto 0) => \^monitor_audio_in\(10 downto 0),
