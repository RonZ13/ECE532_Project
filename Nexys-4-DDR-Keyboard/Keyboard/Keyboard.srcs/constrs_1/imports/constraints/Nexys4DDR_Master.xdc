...
# set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS33} [get_ports PS2_DATA]
#set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS33 } [get_ports { JA[8] }]; #IO_L16P_T2_A28_15 Sch=ja[8]
#set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports { JA[9] }]; #IO_L22N_T3_A16_15 Sch=ja[9]
# set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVCMOS33} [get_ports PS2_CLK]
...
set_property MARK_DEBUG true [get_nets {keycode[0]}]
set_property MARK_DEBUG true [get_nets {keycode[1]}]
set_property MARK_DEBUG true [get_nets {keycode[2]}]
set_property MARK_DEBUG true [get_nets {keycode[3]}]
set_property MARK_DEBUG true [get_nets {keycode[4]}]
set_property MARK_DEBUG true [get_nets {keycode[5]}]
set_property MARK_DEBUG true [get_nets {keycode[6]}]
set_property MARK_DEBUG true [get_nets {keycode[7]}]
set_property MARK_DEBUG true [get_nets {keycode[8]}]
set_property MARK_DEBUG true [get_nets {keycode[9]}]
set_property MARK_DEBUG true [get_nets {keycode[10]}]
set_property MARK_DEBUG true [get_nets {keycode[11]}]
set_property MARK_DEBUG true [get_nets {keycode[12]}]
set_property MARK_DEBUG true [get_nets {keycode[13]}]
set_property MARK_DEBUG true [get_nets {keycode[14]}]
set_property MARK_DEBUG true [get_nets {keycode[15]}]
set_property MARK_DEBUG true [get_nets {keycode[16]}]
set_property MARK_DEBUG true [get_nets {keycode[17]}]
set_property MARK_DEBUG true [get_nets {keycode[18]}]
set_property MARK_DEBUG true [get_nets {keycode[19]}]
set_property MARK_DEBUG true [get_nets {keycode[20]}]
set_property MARK_DEBUG true [get_nets {keycode[21]}]
set_property MARK_DEBUG true [get_nets {keycode[22]}]
set_property MARK_DEBUG true [get_nets {keycode[23]}]
set_property MARK_DEBUG true [get_nets {keycode[24]}]
set_property MARK_DEBUG true [get_nets {keycode[25]}]
set_property MARK_DEBUG true [get_nets {keycode[26]}]
set_property MARK_DEBUG true [get_nets {keycode[27]}]
set_property MARK_DEBUG true [get_nets {keycode[28]}]
set_property MARK_DEBUG true [get_nets {keycode[29]}]
set_property MARK_DEBUG true [get_nets {keycode[30]}]
set_property MARK_DEBUG true [get_nets {keycode[31]}]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {keycode[0]} {keycode[1]} {keycode[2]} {keycode[3]} {keycode[4]} {keycode[5]} {keycode[6]} {keycode[7]} {keycode[8]} {keycode[9]} {keycode[10]} {keycode[11]} {keycode[12]} {keycode[13]} {keycode[14]} {keycode[15]} {keycode[16]} {keycode[17]} {keycode[18]} {keycode[19]} {keycode[20]} {keycode[21]} {keycode[22]} {keycode[23]} {keycode[24]} {keycode[25]} {keycode[26]} {keycode[27]} {keycode[28]} {keycode[29]} {keycode[30]} {keycode[31]}]]
