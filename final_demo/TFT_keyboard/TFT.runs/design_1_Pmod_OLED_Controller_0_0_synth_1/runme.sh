...
HD_PWD='C:/Users/fengbin3/TFT_keyboard/TFT.runs/design_1_Pmod_OLED_Controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Pmod_OLED_Controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Pmod_OLED_Controller_0_0.tcl
