...
//    assign  m_axis_data_tdata_2 = sample_counter < 128 ? 0 : audio_in;
    ...
    (* ram_style = "block" *) reg signed [11:0] waveform_mem[0:NUM_SAMPLES-1];
    ...
    assign m_axis_data_tvalid = select ? vld : vld_w;
    
    //assign vld_out2 = select ? (sample_counter < 128 ? 0 : vld) : (sample_counter2 < 128 ? 0  : vld_w);
    
    initial begin
        $readmemh("audio_mem.mem", waveform_mem);
    end
...
//    logic [11:0] tdata_unpadded = audio_out;
...
//    );
    ...
    assign m_axis_data_tdata = {16'b0, {4{audio_out[11]}}, audio_out};
//    assign m_axis_data_tdata_2 = {16'b0, {4{tdata_unpadded_2[11]}}, tdata_unpadded_2};
    
    assign audio_by1 = {16'b0, {4{audio_out[11]}}, audio_out};
