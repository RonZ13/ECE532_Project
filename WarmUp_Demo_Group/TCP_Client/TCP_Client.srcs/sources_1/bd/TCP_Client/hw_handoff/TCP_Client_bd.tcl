...
################################################################
# This is a generated script based on design: TCP_Client
#
...
proc create_root_design { parentCell } {
  ...
  set gpio_io_i_4 [ create_bd_port -dir I -from 0 -to 0 gpio_io_i_4 ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets microblaze_0_axi_periph_M02_AXI] [get_bd_intf_pins ila_0/SLOT_0_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins gpio_BTND/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins gpio_BTNL/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins gpio_BTNR/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M09_AXI [get_bd_intf_pins gpio_BTNC/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M09_AXI]
  ...
  connect_bd_net -net gpio_io_i_2_1 [get_bd_ports gpio_io_i_2] [get_bd_pins gpio_BTNL/gpio_io_i]
  connect_bd_net -net gpio_io_i_3_1 [get_bd_ports gpio_io_i_3] [get_bd_pins gpio_BTNR/gpio_io_i]
  connect_bd_net -net gpio_io_i_4_1 [get_bd_ports gpio_io_i_4] [get_bd_pins gpio_BTNC/gpio_io_i]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40050000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs gpio_BTNC/S_AXI/Reg] SEG_gpio_BTNC_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40030000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs gpio_BTNL/S_AXI/Reg] SEG_gpio_BTNL_Reg
