...
HD_PWD='D:/ECE532_Project/WarmUp_Demo/TCP_Client/TCP_Client.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TCP_Client_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TCP_Client_wrapper.tcl -notrace
