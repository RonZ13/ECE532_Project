...
HD_PWD='D:/ECE532_Project/WarmUp_Demo/TCP_Client/TCP_Client.runs/TCP_Client_axi_gpio_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TCP_Client_axi_gpio_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TCP_Client_axi_gpio_2_0.tcl
