...
HD_PWD='D:/ECE532_Project/SPI_Controller_Nexys_4_DDR/SPI_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spitest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spitest.tcl
