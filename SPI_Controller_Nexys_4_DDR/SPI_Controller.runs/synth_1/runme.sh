...
HD_PWD='C:/Users/kfranz/Downloads/SPI_Controller/SPI_Controller_Nexys_4_DDR/SPI_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spitest.vds -m64 -mode batch -messageDb vivado.pb -notrace -source spitest.tcl
