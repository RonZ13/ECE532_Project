...
HD_PWD='D:/ECE532_Project/SPI_Controller_Nexys_4_DDR/SPI_Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spitest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spitest.tcl -notrace
