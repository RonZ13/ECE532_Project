...
HD_PWD='C:/Users/kfranz/Downloads/SPI_Controller/SPI_Controller_Nexys_4_DDR/SPI_Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spitest.vdi -applog -m64 -messageDb vivado.pb -mode batch -source spitest.tcl -notrace
