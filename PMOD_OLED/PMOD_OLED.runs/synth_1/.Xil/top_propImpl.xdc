set_property SRC_FILE_INFO {cfile:C:/Users/zhan6738/PMOD_OLED/PMOD_OLED.srcs/constrs_1/imports/constraints/NexysVideo_Master.xdc rfile:../../../PMOD_OLED.srcs/constrs_1/imports/constraints/NexysVideo_Master.xdc id:1} [current_design]
...
connect_debug_port u_ila_0/probe2 [get_nets [list {state[0]} {state[1]} {state[2]} {state[3]} {state[4]}]]
